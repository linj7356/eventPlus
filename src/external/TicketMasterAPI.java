...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "8XvhA9QMC29WCMUXrSyRhsIeV18OOmNu";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		//Make URL "apikey=xxxxxxx&geoPoint=xxxxx$keyword=music&radius=50(default)"
		...
		try {
			...
			//try with resources to make sure close 
	...
	private String getAddress(JSONObject event) throws JSONException{//api not on the top level of response structure
	...
	private String getImageUrl(JSONObject event) throws JSONException{//api not on the top level of response structure
	...
	private Set<String> getCategories(JSONObject event) throws JSONException{//api not on the top level of response structure
